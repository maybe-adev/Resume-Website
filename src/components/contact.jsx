...
const Contact = () => {
    return(
        <form id="contact" action="https://formspree.io/f/xjvznqoz" method="POST" className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-green-800">
            Contact
          </h1>
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <button
                className="flex mx-auto text-white bg-green-800 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">
                Send
              </button>
            </div>
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a className="text-gray-800 hover:text-gray-300" href="mailto:ayushbaral010@gmail.com" target="_blank" without rel="noreferrer">ayushbaral010@gmail.com</a>
              ...
              <span className="inline-flex">
                <a className="mx-2" href="https://www.facebook.com/cautcus" aria-label="Facebook" target="_blank" without rel="noreferrer">
                  <svg className="w-5 h-5 fill-current text-gray-800 hover:text-gray-300" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512">
                    <path
